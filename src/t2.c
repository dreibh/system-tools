...
int main (int argc, char** argv)
{
   ...
   for(int i = 1; i <argc; i++) {
      if( (strcmp(argv[i], "-c") == 0) || (strcmp(argv[i], "--center") == 0) ) {
         ...
         fprintf(stderr, "Usage: %s [-n|--newline] [-i indentation string|--ident indentation string] [--center string] [-s border_left separator border_right|--separator border_left separator border_right]", argv[0]);
         return 1;
      }
      else {
         utf8String = argv[i];
